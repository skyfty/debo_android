...
public class EaseChatExtendMenu extends GridView{
    ...
    public ItemAdapter getMyAdapter(){
        return adapter;
    }
    /**
     * register menu item
    ...
    public class ChatMenuItemModel{
        ...
        public EaseChatExtendMenuItemClickListener getClickListener() {
            return clickListener;
        }

        public void setClickListener(EaseChatExtendMenuItemClickListener clickListener) {
