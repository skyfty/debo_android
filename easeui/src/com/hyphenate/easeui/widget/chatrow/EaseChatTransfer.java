...
public class EaseChatTransfer extends EaseChatRow {
    private TextView tv_howMoney,tishi;

    public EaseChatTransfer(Context context, EMMessage message, int position, BaseAdapter adapter) {
    ...
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                R.layout.ease_row_recerved_transfer : R.layout.ease_row_send_transfer, this);
    }
