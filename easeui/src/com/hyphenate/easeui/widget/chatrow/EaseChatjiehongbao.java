...
public class EaseChatjiehongbao extends EaseChatRow {
        private TextView tv_text;
        public EaseChatjiehongbao(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        public void onSetUpView() {
            ...
            try {
                ...
                if (object.getString("offer_user_nickname")!=null){
                    tv_text.setText(object.getString("first_get_name")+"领取了"+object.getString("offer_user_nickname")+"的红包");
                }else {
