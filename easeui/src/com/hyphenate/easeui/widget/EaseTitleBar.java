...
public class EaseTitleBar extends RelativeLayout {
    ...
    public void useDefaultStatusBar() {
        titleLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, dp2px(getContext(), 50)));
        titleLayout.setPadding(0, 0, 0, 0);
    }

    public void useTransparentStatusBar() {
        titleLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, dp2px(getContext(), 70)));
        titleLayout.setPadding(0, dp2px(getContext(), 20), 0, 0);
    }
