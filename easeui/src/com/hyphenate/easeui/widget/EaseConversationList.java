...
public class EaseConversationList extends ListView{
    ...
    public void init(List<EMConversation> conversationList, /*List<TypeStateBean> date*/Map<String,String> date){
        this.init(conversationList, (EaseConversationListHelper) null,date);
    }

    public void init(List<EMConversation> conversationList, EaseConversationListHelper helper,/*List<TypeStateBean>*/Map<String,String> date){
        ...
        //date1 = date;
        adapter = new EaseConversationAdapter(context, 0, conversationList,this.date1);
    ...
    public void filter(CharSequence str) {
        Log.i("EaseConversationList",".........filter="+str.toString());
    ...
    public void update(/*List<TypeStateBean> list*/Map<String,String> date){
       // if (date1 != null)
        date1.clear();
        /*else
        date1 = new HashMap<String, String>();*/
        date1.putAll(date);
