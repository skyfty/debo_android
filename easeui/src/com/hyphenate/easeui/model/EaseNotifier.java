...
import com.hyphenate.easeui.utils.CheckIsBackGroundUtil;
...
public class EaseNotifier {
    ...
    public synchronized void onNewMsg(EMMessage message) {
        ...
        if (CheckIsBackGroundUtil.isBackground(appContext)) {
...
//                notificationManager.cancel(foregroundNotifyID);
                ...
                BadgeUtil.sendBadgeNotification(notification, notifyID, appContext, notificationNum, notificationNum);
//                notificationManager.cancel(notifyID);
//                notifyID++;
    ...
    public void vibrateAndPlayTone(EMMessage message) {
        ...
        try {
            ...
            if (settingsProvider.isMsgSoundAllowed(message)) {
                if (ringtone == null) {
                    Uri notificationUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.sound);
