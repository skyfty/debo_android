...
public class EaseBaiduMapActivity extends EaseBaseActivity {
    ...
    private final static String TAG = "EaseBaiduMapActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (latitude == 0) {
            ...
            Log.i(TAG," ============latitude"+latitude+"      "+longtitude);
    ...
    private void showMapWithLocationClient() {
        ...
        progressDialog.setOnCancelListener(new OnCancelListener() {
            ...
            public void onCancel(DialogInterface arg0) {
                ...
                Log.i(TAG, "cancel retrieve location");
                finish();
            }
        });
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(final BDLocation location) {
            ...
            Log.i(TAG, "On location change received:" + location);
            Log.i(TAG, "addr:" + location.getAddrStr()+"     "+location.getCity()+"   "+location.getCityCode()+"   "+location.getCoorType()+"    "+location.getCountry());
                ...
                public void run() {
                    ...
                    if (lastLocation != null) {
                        if (lastLocation.getLatitude() == location.getLatitude() && lastLocation.getLongitude() == location.getLongitude()) {
                            Log.i(TAG, "same location, skip refresh");
