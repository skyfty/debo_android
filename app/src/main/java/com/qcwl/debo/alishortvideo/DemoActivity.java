...
package com.qcwl.debo.alishortvideo;
...
public class DemoActivity extends Activity {
    ...
    private int[] demoRes = new int[]{R.mipmap.demo_vedio_icon,R.mipmap.demo_crop_icon};
    private int [] demoTitles = new int[]{R.string.record,R.string.crop};
        ...
        demoAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void OnItemClick(View view, int position) {
                if(position < demoRes.length){
                    ...
                    if(key == R.mipmap.demo_crop_icon) {
                        Intent crop = new Intent("com.aliyun.action.snapcrop");
                        startActivity(crop);
