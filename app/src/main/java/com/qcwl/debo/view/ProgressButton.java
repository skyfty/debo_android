...
public class ProgressButton extends Button {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mProgressDrawable = (GradientDrawable) getResources().getDrawable(
                R.drawable.rect_light_green).mutate();
        ...
        try {
            ...
            int defaultProgressColor1 = getResources().getColor(R.color.color_60D44F);
            int progressColor1 = attr.getColor(R.styleable.progressbutton_progressColor1, defaultProgressColor1);
            mProgressDrawable.setColor(progressColor1);


            int defaultProgressBgColor1 = getResources().getColor(R.color.color_60D44F);
            int progressBgColor1 = attr.getColor(R.styleable.progressbutton_progressBgColor, defaultProgressBgColor1);
            mProgressDrawableBg.setColor(progressBgColor1);
    ...
    private Drawable getNormalDrawable(TypedArray attr) {
        ...
        GradientDrawable drawableNormal =
                (GradientDrawable) getResources().getDrawable(R.drawable.rect_light_green).mutate();// 修改时就不会影响其它drawable对象的状态
        drawableNormal.setCornerRadius(cornerRadius); // 设置圆角半径

        int defaultNormal = getResources().getColor(R.color.color_60D44F);
    ...
    private Drawable getPressedDrawable(TypedArray attr) {
        ...
        int defaultPressed = getResources().getColor(R.color.color_60D44F);
