...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    static final String TAG="ExpandableTextView";
    ...
    private static int getRealTextViewHeight(@NonNull TextView textView) {
        ...
        Log.i(TAG,"ExpandCollapseAnimation="+textHeight+"     "+padding+"     "+textView.getLineCount()+"    "+textView.getCompoundPaddingTop()+"      "+textView.getCompoundPaddingBottom());
    ...
    class ExpandCollapseAnimation extends Animation {
        ...
        public ExpandCollapseAnimation(View view, int startHeight, int endHeight) {
            ...
            Log.i(TAG,"ExpandCollapseAnimation="+mTargetView+"     "+mStartHeight+"     "+mEndHeight+"    "+mAnimationDuration);
        }
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            Log.i(TAG,"applyTransformation="+mEndHeight+"     "+mStartHeight+"     "+mMarginBetweenTxtAndBottom+"    "+newHeight);
        ...
        public void initialize( int width, int height, int parentWidth, int parentHeight ) {
            ...
            Log.i(TAG,"initialize="+width+"     "+height+"     "+parentWidth+"    "+parentHeight);
        }
