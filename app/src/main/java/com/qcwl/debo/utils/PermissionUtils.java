...
//    	ToastUtils.showShort(App.getApp(), "进入");
        ...
        if (permissionsList.size() > 0) {
            ...
            Log.d(TAG, "showMessageOKCancel requestLocationPermissions");
        ...
        showMessageOKCancel(activity, "Rationale: " + permissionsHint[requestCode], new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ActivityCompat.requestPermissions(activity,
                        ...
                        requestCode);
                Log.d(TAG, "showMessageOKCancel requestLocationPermissions:" + requestPermission);
            }
        });
    }
     ...
     * 打电话的权限
     */
    public static void requestPermissions(Activity context, String phone) {
        //判断当前是否获取到打电话的权限
