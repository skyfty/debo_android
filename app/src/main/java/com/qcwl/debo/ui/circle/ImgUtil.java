...
public class ImgUtil {
    ...
    public static void load(Context context, String imgUrl, final ImageView imageView) {
        ...
        if (!AppUtils.isNullTxt(imgUrl) && null != imageView)
            Glide.with(context)
                    .load(imgUrl)
    ...
    public static void load2(Context context, String imgUrl, final ImageView imageView) {
        if (null == context) {
            if (context instanceof Activity) {
                if (((Activity) context).isFinishing()|| ((Activity) context).isDestroyed()) {
                    return;
    ...
    public static void setGlideHead(Context context, String avatar, ImageView imageView) {
        ...
        if (!AppUtils.isNullTxt(avatar) && null != imageView)
            Glide.with(context)
