...
public class DirectRenMaiListActivity extends BaseActivity implements ContactListPresenterInf {
    ...
    private void initTitleBar() {
        new TitleBarBuilder(this).setTitle("直接人脉").setImageLeftRes(R.mipmap.back).setLeftListener(new View.OnClickListener() {
            @Override
    ...
    private void initView() {
        ...
        refresh_layout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                contactListPresenter.getReMai(DirectRenMaiListActivity.this, sp.getString("phone"), "1", list);
            }
        });
        ...
        contactListPresenter.getReMai(this, sp.getString("phone"), "1", list);
    }
    ...
    private void monitor() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(DirectRenMaiListActivity.this, ChatActivity.class).putExtra("userId",adapter.getList().get(position).getMobile()).putExtra("nickname",adapter.getList().get(position).getUser_nickname()).putExtra("type","2"));
            }
        });
    }
