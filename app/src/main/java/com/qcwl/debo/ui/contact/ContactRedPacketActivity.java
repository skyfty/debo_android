...
public class ContactRedPacketActivity extends BaseActivity {
    ...
    private void initTitleBar() {
        new TitleBarBuilder(this).setTitle("发送红包").setAlpha(1).setImageLeftRes(R.mipmap.back).setLeftListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
