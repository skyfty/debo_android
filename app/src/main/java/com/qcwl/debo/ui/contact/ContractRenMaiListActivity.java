...
public class ContractRenMaiListActivity extends BaseActivity implements ContactListPresenterInf {
    ...
    private void initTitleBar() {
        new TitleBarBuilder(this).setTitle("合约人脉").setImageLeftRes(R.mipmap.back).setLeftListener(new View.OnClickListener() {
            @Override
    ...
    private void initView() {
        ...
        refresh_layout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                contactListPresenter.getReMai(ContractRenMaiListActivity.this, sp.getString("phone"), "3", list);
            }
        });
        ...
        contactListPresenter.getReMai(this, sp.getString("phone"), "3", list);
    }
    ...
    private void monitor() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(ContractRenMaiListActivity.this, ChatActivity.class).putExtra("userId",adapter.getList().get(position).getMobile()).putExtra("nickname",adapter.getList().get(position).getUser_nickname()).putExtra("type","2"));
            }
        });
    }
