...
public class PersonalAdapter2 extends BaseQuickAdapter<Joke_list, BaseViewHolder> implements TouchDataCallBack{
    FragmentActivity fragmentActivity;
    List<Joke_list> joke_lists;
    int height;
    int resId;
    private String TAG = "PersonalAdapter";
    String avatar, nickname, is_follow;
    public int position2;
    public PersonalAdapter2(FragmentActivity fragmentActivity, int layoutResId, @Nullable List<Joke_list> data, String avatar, String nickname, String is_follow, int height) {
        super(layoutResId, data);
        this.fragmentActivity = fragmentActivity;
        this.joke_lists = data;
        this.height = height;
    ...
    @Override
    protected void convert(BaseViewHolder helper, Joke_list item) {
        ...
        helper.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putSerializable("data",(Serializable) joke_lists);
    ...
    public JSONObject doSomeThing(int i) {
        Log.i("JokeAdapter","..............="+(position2+i)+"       "+joke_lists.size()+"　　　　"+position2);
        position2 = position2+i;
        if(position2>=joke_lists.size()||position2<0){
            position2 = position2-i;
            return null;
        }
        Joke_list videoBean = joke_lists.get(position2);
