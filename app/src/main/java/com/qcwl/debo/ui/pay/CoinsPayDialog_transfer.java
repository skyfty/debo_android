...
import com.qcwl.debo.chat.Transfer_pushActivity;
...
public class CoinsPayDialog_transfer {
    ...
    public static Dialog createDialog(Context context, String order_sn, String title, String total,String content,String price) {
        mContext = context;
        mOrder_sn = order_sn;
        mTitle = title;
        mTotal = total;
            ...
            public void onSuccess(ApiResponse apiResponse) {
                ...
                if (apiResponse.getCode() == 0) {
                    ...
                    if (!(mContext instanceof WishingStarActivity)) {
                        if (mContext instanceof Transfer_pushActivity){
                            ...
                            try {
                                ...
                                intent.putExtra("order_price",mPrice);
                                ((Transfer_pushActivity) mContext).setResult(Activity.RESULT_OK,intent);
