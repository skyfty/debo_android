...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    private Button answerBtn, btn_stop;
...
//        TextView nickTextView = (TextView) findViewById(R.id.tv_nick);
        ...
        imagePhoto = (RoundedImageView) findViewById(R.id.image_photo);
        ...
        EaseUserUtils.setUserNick(this, username, textName, imagePhoto);
                    ...
                    case DISCONNECTED:
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //2018年08月17日11:43更正  代码过于杂乱，与视频通话代码保持一致
