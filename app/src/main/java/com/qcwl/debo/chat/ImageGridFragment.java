...
import com.qcwl.debo.utils.PermissionUtils;
import com.qcwl.debo.view.RecyclingImageView;
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(mContext).inflate(
						R.layout.em_choose_griditem, container, false);
			...
			if (position == 0) {
				...
				holder.imageView
						.setImageResource(R.mipmap.em_actionbar_camera_icon);
			} else {
				...
				Log.i("video_url",entty.filePath+"*-*"+entty.duration);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK) {
			if (requestCode == 100) {
				...
				String durRecorder = data.getStringExtra("durRecorder");
				...
				getActivity().setResult(
						...
						getActivity().getIntent().putExtra("path", filePath)
								.putExtra("dur", duration).putExtra("durRecorder", durRecorder));
				getActivity().finish();
