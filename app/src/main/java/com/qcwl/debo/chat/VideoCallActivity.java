...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    private LinearLayout comingBtnContainer, llCommunication, llMianTi;
    ...
    private TextView tvIsStopvoice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llCommunication = (LinearLayout) findViewById(R.id.llCommunication);

        llMianTi = (LinearLayout) findViewById(R.id.llMianTi);

        tvIsStopvoice = (TextView) findViewById(R.id.tvIsStopvoice);
...
//        nickTextView.setText(username);
        EaseUserUtils.setUserNick(this, username, nickTextView, image_photo);
        // local surfaceview
        ...
        if (!isInComingCall) {// outgoing call
            ...
            callStateTextView.setText("正呼叫您");
...
//                                        callStateTextView.setText(s6);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_mute: // mute点击静音（切换至语音按钮）
                if (isVoice) {//处于语音通话   点击按钮做静音操作
                    if (isMuteState) {
                        // resume voice transfer
                        muteImage.setImageResource(R.mipmap.ic_yy_on);
                        try {
                        ...
                        isMuteState = false;
                    } else {//1.将切换至语音按钮换成静音按钮
                        // pause voice transfer
                        muteImage.setImageResource(R.mipmap.ic_yy_off);
                        tvIsStopvoice.setText(getResources().getString(R.string.mute));
                        try {
                    ...
                    switchCameraBtn.setVisibility(View.GONE);
                    nickTextView.setVisibility(View.VISIBLE);
                    llMianTi.setVisibility(View.VISIBLE);
                    image_photo.setVisibility(View.VISIBLE);

                    muteImage.setImageResource(R.mipmap.ic_yy_on);
                    tvIsStopvoice.setText(getResources().getString(R.string.mute));
                    rootContainer.setBackgroundColor(Color.BLACK);
                    handsFreeImage.setImageResource(R.mipmap.ic_yywaifang);
                ...
                break;
            case R.id.iv_handsfree: // handsfree点击免提
                if (isHandsfreeState) {
                    // turn off speaker
                    handsFreeImage.setImageResource(R.mipmap.ic_yywaifang);
                    closeSpeakerOn();
                    ...
                    handsFreeImage.setImageResource(R.mipmap.ic_yywaifangs);
                    openSpeakerOn();
                    isHandsfreeState = true;
                }
