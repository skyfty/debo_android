...
public class CallActivity extends BaseActivity {
    ...
    protected final int MSG_CALL_MAKE_VIDEO = 0;//视频通话
    protected final int MSG_CALL_MAKE_VOICE = 1;//语音通话
    protected final int MSG_CALL_ANSWER = 2;//接听
    protected final int MSG_CALL_REJECT = 3;//拒绝
    protected final int MSG_CALL_END = 4;//挂断
